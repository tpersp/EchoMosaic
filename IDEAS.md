...
- [x] Custom stream labels/names and user-selected color tags for easier dashboard navigation - This would give a custom /steam/*custom-name* and option to create custom group of streams like a "stream group" so user can choose which streams to show on a custom multi-stream, similar to the original /stream page.
